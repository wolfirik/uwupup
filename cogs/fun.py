...
class Fun_Commands:
    ...
    async def floof(self, ctx):
        ...
        r = requests.get('https://e926.net/post/index.json?limit=1&tags=cute%20solo%20fur%20order:random%20-type:webm%20-type:swf%20-my_little_pony') #a lot more complex than the other apis
        r = r.json()
